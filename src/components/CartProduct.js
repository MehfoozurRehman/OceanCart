...
export default function CartProduct() {
  return (
    <div className="cart__product__container">
        ...
        <img style={{width:"100px",borderRadius:"8px", marginRight:"1em"}} src={CartProductImg} alt="cart__product_img" />

      <div className="cart__product__content" style={{flex:1}}>
        <div>
        <div className="cart__product__heading">Ajmal Mizyaan for Men </div>
        <div className="cart__product__text">By Lorem ipsum dolor</div>
        </div>
        <div className="cart__product__left" ><div className="cart__product__price">$40</div> <div className="cart__product__delivery">
      ...
      <div className="cart__product__content__right">
        ...
        <div className="main__product__content__quantity">
          ...
          <Button veriant="dark" className="cart__product__remove__btn" >Remove</Button>
